...
export default function PrivacyLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className='sm:pt-20 pt-12 sm:w-[90%] w-full sm:px-0 px-4 self-center sm:pb-40 pb-20'>
      <SectionHeading heading="Privacy Policy" caption="LEGAL" />
      <div className='bg-(--placeholder)/30 h-[0.5px] w-full sm:mt-40 mt-20'></div>
      <div className='flex sm:flex-row flex-col sm:mt-15 mt-5'>
